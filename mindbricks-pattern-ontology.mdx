...
| Field        | Description                                                                                                                                                          |
| ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| tokenHost    | The base URL of the SSO provider (e.g., [https://auth.example.com](https://auth.example.com)). This value is used as the root for building all other endpoint paths. |
...
| aggType     | The mathematical operation to perform (e.g., 'value\_count', 'sum', 'average', 'min', 'max').                                                                                                                |
...
| jwtKey        | An MScript value that evaluates to the Jwt key to validate the token signature. It may be an hardcoded value like `1234560987abcdef` or a reference to context like this.jwtKey or a env reference like process.env.SUBS\_KEY.                                                                                                                                   |
